...
// Jika tidak ada parameter dari tombol, redirect ke home
if (!isset($_GET['from']) || $_GET['from'] !== 'home') {
	...
	$icon = "template\masuk\images\cafe.jpg";
	session_start();
			...
			<div class="wrap-login100 p-t-120 p-b-30">
				<form action="" method="post" class="login100-form validate-form">
					...
					?>
						...
						<img src="<?php echo $_SESSION['user_picture']; ?>" alt="Foto Profil" width="100">
						<br><br>
